                    ...
                    <div class="box">
                        ...
                        <div class="box-body" style="display: block; overflow: scroll; overflow-x: scroll; width: auto;">
                            <table id="example1" class="table table-bordered table-sm">
                                ...
                                <?php
                                $eid=$_SESSION['eid'];
                                $row = $conn->query("SELECT * FROM `file_upload` WHERE uploaded_by='$eid' OR uploaded_by='admin'") or die(mysqli_error());
                                while($fetch = $row->fetch_array()){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="download.php?file=<?php echo $name[3]?>" class="btn btn-info"><span class="glyphicon glyphicon-download"></span> Download</a>
                                            <a onClick="return checkDelete()" href="deletefile.php?fileid=<?php echo $id[0]?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete file</a>
                                        </td>
