        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="category" class="col-sm-3 control-label">Leave Category</label>
                    ...
                    <div class="form-group">
                        <label for="time_in" class="col-sm-3 control-label">Start of leave</label>

                        <div class="col-sm-9">
                            <div class="date">
                                <input type="date" class="form-control" id="time_in" name="time_in">
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="time_out" class="col-sm-3 control-label">End of leave</label>

                        <div class="col-sm-9">
                            <div class="date">
                                <input type="date" class="form-control" id="time_in" name="time_out">
                            </div>
                        </div>
                    </div>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-primary btn-flat" name="add"> Submit</button>
            	</form>
          	</div>
        </div>
    </div>
