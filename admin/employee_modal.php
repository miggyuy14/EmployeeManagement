          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="conpassword" class="form-control" id="conpassword" name="conpassword" required>
                        </div>
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" id="datepicker_add" name="birthdate" placeholder="yyyy-mm-dd">
                      </div>
                  	</div>
                </div>
                <div class="form-group">
...
<!--Add Fingerprint-->
<div class="modal fade" id="add_fingerprint">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
