...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
           ...
           <!---------
                <a href="#addfinger" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New Fingerprint</a>
        -------->        
                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                        <tr>
                           <td><button type="button" class="select_btn" id="<?php echo $fingerid;?>" title="select this UID"><?php echo $fingerid;?></button></td>
                          ...
                          <td>
                            ...
                            <button  class="btn btn-success btn-sm edit btn-flat" data-toggle="" data-target="#edit<?php echo $row['employee_id']; ?>" data-id="<?php echo $row['empid']; ?>"><i class="fa fa-edit"></i> Edit</button>
  ...
  <?php include 'includes/employee_modal.php'; ?>
    <?php include 'includes/fingerprint_modal.php'; ?>
</div>
...
$(function(){
  ...
  $('.delete').click(function(e){
    ...
    $('.add_fingerprint').click(function(e){
        e.preventDefault();
        $('#add_fingerprint').modal('show');
        var id = $(this).data('id');
        getRow(id);
    });
