                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered">
                                ...
                                $row = $conn->query("SELECT * FROM `leaves` WHERE status='For approval'") or die(mysqli_error());
                                while($fetch = $row->fetch_array()){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="leave_approve.php?leaveid=<?php echo $id[0]?>" class="btn btn-primary">Approve</a>
                                            <a  href="leave_decline.php?leaveid=<?php echo $id[0]?>" class="btn btn-danger">Decline</a>
                                        </td>
